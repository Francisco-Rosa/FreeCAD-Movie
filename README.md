...
7. To apply animation from another workbench, see instructions in "Preparation" above.
...
8. To apply animation from another workbench, see instructions in "Preparation" above.
